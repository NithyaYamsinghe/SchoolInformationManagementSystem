...
<html lang="zxx">
<head>
	<title>Southbank | Add Subjects</title>
	<!-- Meta tag Keywords -->
	...
	<section class="contact py-5" id="contact">
		<div class="container py-xl-5 py-lg-3">
			<div class="register-w3 py-5">
				<div class="container py-xl-5 py-lg-3">
					<h3 class="tittle text-center text-bl font-weight-bold">Add New Subject</h3>
						...
						<div class="comment-bottom mobamuinfo_mail_grid_right">
							<form action="AddSubjectServlet" method="post">
								...
								<div class="row">
									<div class="col-lg-6 form-group">
										<label>Head Teacher Name</label> <input class="form-control" type="text"
											name="teacherName" placeholder="Head Teacher Name" required="required">
									</div>
									<div class="col-lg-6 form-group">
								...
								<div class="row">
									<div class="col-lg-6 form-group">
										<button type="submit" class="btn submit mt-3"
											value="Add Subject">Add Subject</button>
									</div>
									<div class="col-lg-6 form-group">
								...
								<div class="row">
									...
									<div class="col-lg-6 form-group">
										<button type="submit" class="btn submit mt-3" value="List All Subjects">View All Subjects</button>
									</div>
									</form>
								</div>
							</div>
