...
<head>
    ...
    <!-- Title Page-->
    <title>Southbank | Delete Subject</title>
    <!-- Footer-CSS -->
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Search Subject</h2>
                    <form method="POST" action="DeleteSubjectServlet">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Subject ID</label>
                                    <input class="input--style-4" type="text" name="subjectID" >
                                </div>
                            </div>
                         </div>
                        
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit">Delete Subject</button>
                        </div>
                    </form>
                </div>
            </div>
