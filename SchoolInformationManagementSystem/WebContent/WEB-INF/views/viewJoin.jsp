<%@page import="com.oop.model.Join"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.oop.service.JoinServiceImpl"%>
<%@page import="com.oop.service.IJoinService"%>
...
<head>
	...
	<title>Southbank | View Join</title>
	<link rel="stylesheet"
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>
							Registered Students For <b>Aptitude Test</b>
						</h2>
					</div>
			...
			ArrayList<Join> arrayList = iJoinService.getJoin();
			
			for(Join join : arrayList){
			%>
				<tbody>
					<tr>
						<td><%=join.getJoinID() %></td>
						<td> <%=join.getName() %></td>
						<td><%=join.getBirthDate() %></td>
						<td><%=join.getGender() %></td>
						<td> <%=join.getEmail() %></td>
						<td> <%=join.getPhoneNumber() %></td>
