...
<head>
	...
	<title>Southbank | View Students</title>
	<link rel="stylesheet"
...
%>
	...
	<div>
		...
		<!--  <a href="addStudent.jsp"><button type="submit" class="btn submit mt-3"
				value="">Add New Student</button></a> -->
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th style="width: 45%;">Date Of Admission</th>
						<th style="width: 35%;">Address</th>
						<th style="width: 55%;">Date Of Birth</th>
						<th style="width: 45%;">Guardian Name</th>
						<th style="width: 45%;">Stream</th>
