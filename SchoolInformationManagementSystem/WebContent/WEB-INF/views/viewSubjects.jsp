...
<%@page import="com.oop.service.SubjectServiceImpl"%>
<%@page import="com.oop.service.ISubjectService"%>
...
<head>
	...
	<title>Southbank | View Subjects</title>
	<link rel="stylesheet"
...
%>
	...
	<div>
		<center><h3 style="color: green;">${successfullyAddedSubject}</h3></center>
		<center><h3 style="color: green;">${successfullyUpdatedSubject}</h3></center>
		<center><h3 style="color: green;">${successfullyDeletedSubject}</h3></center>
		<center><h3 style="color: red;">${subjectNotFound}</h3></center>
		<!--  <a href="addSubject.jsp"><button type="submit" class="btn submit mt-3"
				value="">Add New Subject</button></a>-->
	</div>
	<div class="container">
		<div class="table-wrapper">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th style="width: 35%;">TeacherID</th>
						<th style="width: 35%;">Teacher Name</th>
						<th style="width: 25%;">Credits</th>
						<th style="width: 35%;">Delivering Grade</th>
			...
			ArrayList<Subject> arrayList = iSubjectService.getSubjects();
			...
			%>
				<tbody>
					<tr>
						...
						<td><%=subject.getDeliveringGrade() %></td>
						<td><%=subject.getDepartment() %></td>
						
						<td>
						<form method="POST" action="GetSubjectServlet">
