<%@page import="com.oop.model.Subject"%>
...
<html lang="zxx">
<head>
	<title>Southbank | Update Subject</title>
	<!-- Meta tag Keywords -->
...
%>
	...
	<div id='cssmenu'>
		<ul>
			...
			<li><a href='addSubject.jsp'><span>Add New Subjects</span></a></li>
							...
							<form action="UpdateSubjectServlet" method="post">
								<div class="row">
									<div class="col-lg-6 form-group">
										<label>Subject ID</label> <input class="form-control"
											type="text" name="subjectID" placeholder="Student ID"
											required="required" disabled="disabled" value="<%=subject.getSubjectID()%>">
									</div>
								</div>
								<div class="row">
									<div class="col-lg-6 form-group">
										<label>Subject Name</label> <input class="form-control"
											type="text" name="subjectName" placeholder="Subject Name"
											required="required" value="<%=subject.getSubjectName()%>">
									</div>
									<div class="col-lg-6 form-group">
										<label>Head Teacher ID</label> <input class="form-control"
											type="text" name="teacherID" placeholder="Head Teacher ID"
											required="required" value="<%=subject.getTeacherID()%>">
									</div>
								</div>
								<div class="row">
									<div class="col-lg-6 form-group">
										<label>Head Teacher Name</label> <input class="form-control" type="text"
											name="teacherName" placeholder="Head Teacher Name"  value="<%=subject.getTeacherName()%>" required="required">
									</div>
									<div class="col-lg-6 form-group">
										<label>Credits</label> <input class="form-control"
											type="text" name="credits" placeholder="Credits"
											required="required"  value="<%=subject.getCredits()%>">
									</div>

								</div>
								<div class="row">
									<div class="col-lg-6 form-group">
										<label>Delivering Grade</label> <input class="form-control"
											type="text" name="deliveringGrade" placeholder="Delivering Grade"
											required="required" value="<%=subject.getDeliveringGrade()%>">
									</div>
									<div class="col-lg-6 form-group">
										<label>Department</label> <input class="form-control" type="text"
											name="department" placeholder="Department" required="required" value="<%=subject.getDepartment()%>">
									</div>
								...
								<div class="row">
									<div class="col-lg-6 form-group">
										...
										<button type="submit" class="btn submit mt-3"
											value="Update Subject">Update Subject</button>
									</div>
									</form>
									<div class="col-lg-6 form-group">
									<form method="POST" action="DeleteSubjectServlet">
											<input type="hidden" name="subjectID"
												value="<%=subject.getSubjectID()%>" />
											<button type="submit" class="btn submit mt-3"
												value="Delete Subject">Delete Subject</button>
									</form>		
									</div>
								...
								<div class="row">
								<div class="col-lg-6 form-group">
								<form method="post" action="ListSubjectServlet">
									<button type="submit" class="btn submit mt-3"
										value="List All Subjects">View All Subjects</button>
								</form>
								</div>
								</div>
							</div>
		...
		<div class="footer-top-agileinfo">
			...
			<div class="footer-top-grids-wthree ftm-w3">
				...
				<ul>
					...
					<li><a href="homeSubject.jsp">Subject Management</a></li>
					<li><a href="addSubject.jsp">Add New Subjects</a></li>
				</ul>
			</div>
