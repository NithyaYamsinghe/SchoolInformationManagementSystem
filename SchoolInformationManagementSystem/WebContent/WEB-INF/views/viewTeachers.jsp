...
<head>
	...
	<title>Southbank | View Teachers</title>
	<link rel="stylesheet"
...
%>
	...
	<div>
		<center><h3 style="color: green;">${successfullyAddedTeacher}</h3></center>
		<center><h3 style="color: green;">${successfullyUpdatedTeacher}</h3></center>
		<center><h3 style="color: green;">${successfullyDeletedTeacher}</h3></center>
		<center><h3 style="color: red;">${teacherNotFound}</h3></center>
		<!-- <a href="addTeacher.jsp"><button type="submit" class="btn submit mt-3"
				value="">Add New Teacher</button></a> -->
	</div>
	<div class="container">
		<div class="table-wrapper">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						<th style="width: 50%;">Teacher Id</th>
						<th style="width: 55%;">Teacher Name</th>
						<th style="width: 65%;">Date Of Registration</th>
						<th style="width: 45%;">Address</th>
						<th style="width: 65%;">Date Of Birth</th>
						<th style="width: 65%;">Specialization</th>
						<th style="width: 55%;">Qualification</th>
						<th style="width: 55%;">Department</th>
						<th style="width: 65%;">TelephoneNo</th>
			...
			%>
				<tbody>
					<tr>
						...
						<td><%=teacher.getDateOfRegistration() %></td>
						<td><%=teacher.getAddress() %></td>
						<td> <%=teacher.getDateOfBirth() %></td>
						<td><%=teacher.getSpecialization() %></td>
						<td><%=teacher.getQualification() %></td>
						<td> <%=teacher.getDepartment() %></td>
						<td><%=teacher.getTelephoneNo() %></td>
