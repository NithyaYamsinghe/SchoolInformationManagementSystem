...
<body>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						<h6>Welcome To SouthBank International School</h6>
						<h3>
							Leading <span>International school</span>
						</h3>
						<p>Create your future with Southbank....</p>
					</div>
				</div>
			</div>
			<div class="item item2">
				<div class="container">
					<div class="carousel-caption">
						<h6>Welcome To SouthBank International School</h6>
						<h3>
							Most Popular <span>Education</span>
						</h3>
						<p>Best teachers and best facilities.</p>
					</div>
				</div>
			</div>
			<div class="item item3">
				<div class="container">
					<div class="carousel-caption">
						<h6>Welcome To SouthBank International School</h6>
						<h3>
							We Can <span>Teach</span> You
						</h3>
						<p>Right Path to success.</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="welcome-sub-wthree">
				<div class="col-md-6 banner_bottom_left">
					<h4>
						About <span>SouthBank International School</span>
					</h4>
					<p>SouthBank International School is a well reputed international school all over the world,
					thousands of success stories behind SouthBank International School.</p>
					<p>When choosing a best place to continue your studies SouthBank International School provide the best teachers and best facilities to built your bright future.</p>
				</div>
				<!-- Stats-->
				<div class="col-md-6 stats-info-agile">
					<div class="col-xs-6 stats-grid stat-border">
						<div class='numscroller numscroller-big-bottom' data-slno='1'
							data-min='0' data-max='768' data-delay='.5' data-increment="1">768</div>
						<p>Faculties</p>
					</div>
					<div class="col-xs-6 stats-grid">
						<div class='numscroller numscroller-big-bottom' data-slno='1'
							data-min='0' data-max='678' data-delay='.5' data-increment="1">678</div>
						<p>Subjects</p>
					</div>
					<div class="clearfix"></div>
					<div class="child-stat">
						<div class="col-xs-6 stats-grid stat-border border-st2">
							<div class='numscroller numscroller-big-bottom' data-slno='1'
								data-min='0' data-max='800' data-delay='.5' data-increment="1">800</div>
							<p>Certified Teachers</p>
						</div>
						<div class="col-xs-6 stats-grid">
							<div class='numscroller numscroller-big-bottom' data-slno='1'
								data-min='0' data-max='485' data-delay='.5' data-increment="1">485</div>
							<p>Happy Students</p>
						</div>
						<div class="clearfix"></div>
					</div>
			...
			<div class="services-moksrow">
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<p>SouthBank International School provide wide range of subjects that students can choose</p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<p>Admiring students with higher performances in every and awarded them with scholarships </p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Book Library</h4>
						<p>SouthBank International School has the largest book library with wide range of books</p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="services-moksrow">
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Best Teachers</h4>
						<p>Well certified best teachers are in SouthBank International School to direct you for the right path </p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<p>24 / 7  Transport Facility with best transporting service for free, for students security </p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Excellent Lab</h4>
						<p>High quality laboratories with latest technologies and facilities with 24/7 internet facility</p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
	...
	<div class="news" id="news">
		<div class="container">
			<div class="title-div">
				<h3 class="tittle">
					<span>O</span>ur <span> E</span>vents
				</h3>
				<div class="tittle-style"></div>
			</div>
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color1">
								<a href="#" data-toggle="modal" data-target="#myModal">Minihackthon Coding Challenge</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#"> <span class="fa fa-clock-o" aria-hidden="true"></span>
										7:00 pm - 9:00 pm
									</a>
								</div>
								<div class="time">
							...
							<div class="news-grid-info-bottom-w3ls-text">
								<p>Inter school coding challenge.</p>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color2">
								<a href="#" data-toggle="modal" data-target="#myModal">Annual Prize Giving</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#"> <span class="fa fa-clock-o" aria-hidden="true"></span>
							...
							<div class="news-grid-info-bottom-w3ls-text">
								<p>Annual Prize Giving of SouthBank International School.</p>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color3">
								<a href="#" data-toggle="modal" data-target="#myModal">Open Day</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#"> <span class="fa fa-clock-o" aria-hidden="true"></span>
								...
								<div class="time">
									<p>
										<span class="fa fa-map-marker" aria-hidden="true"></span>
										At SouthBank International School premises
									</p>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="news-grid-info-bottom-w3ls-text">
								<p>Annual Open Day of SouthBank International School.</p>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color4">
								<a href="#" data-toggle="modal" data-target="#myModal">Parents Meeting</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#"> <span class="fa fa-clock-o" aria-hidden="true"></span>
	...
	<div class="middle-sec-agile">
		<div class="container">
			<h4>
				Our <span>SouthBank International</span> School
			</h4>
			<ul>
				<li>
					...
					<div class="middle-right">
						<h5>Fill Online registration form for aptitude Test!</h5>
						<p>Join with us.</p>
					</div>
					<div class="clearfix"></div>
				</li>
				<li>
					...
					<div class="middle-right">
						...
						<p>Join for SouthBank International School seminar to know more about us.</p>
					</div>
					<div class="clearfix"></div>
				</li>
				<li>
					...
					<div class="middle-right">
						...
						<p>Enrolled with us and make your path of success.</p>
					</div>
					<div class="clearfix"></div>
				</li>
			</ul>
			<a class="button-style" href="join.jsp">Register For Aptitude Test</a>
		</div>
	...
	<div class="testimonials">
		<div class="container">
			<div class="title-div">
				<h3 class="tittle">
					<span>O</span>ur <span>S</span>tudent's <span>S</span>ay
				</h3>
				<div class="tittle-style"></div>
			</div>
			<ul id="flexiselDemo1">
				<li>
					<div class="three_testimonials_grid_main">
						...
						<div class="col-xs-9 three_testimonials_grid">
							...
							<p>Joining with SouthBank International School is the best decision I ever made. Best place with best teachers and wide range of subject to choose.</p>
						</div>
						<div class="clearfix"></div>
					</div>
				</li>
				<li>
					<div class="three_testimonials_grid_main">
						...
						<div class="col-xs-9 three_testimonials_grid">
							...
							<p>After my primary studies I have to transfer  to a another school for my secondary education. my parent's choose SouthBank International School.
							I guaranteed their service. Love my school!</p>
						</div>
						<div class="clearfix"></div>
					</div>
				</li>
				<li>
					<div class="three_testimonials_grid_main">
						...
						<div class="col-xs-9 three_testimonials_grid">
							...
							<p>SouthBank International School has the best laboratories and largest library with wide variety of books. I truly happy to be student of SouthBank International School.
							The best school.</p>
						</div>
						<div class="clearfix"></div>
					</div>
			...
			<div class="container">
				<div class="mkls_footer_grid">
					...
					<div class="col-xs-4 mkls_footer_grid_left">
						...
						<p>
							<span>Email : </span> <a href="mailto:info@example.com">Southbank@info.com</a>
						</p>
					</div>
					<div class="col-xs-4 mkls_footer_grid_left">
						<h4>Opening Hours:</h4>
