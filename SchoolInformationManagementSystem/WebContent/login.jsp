...
<body>
	...
	<div class="register-form-main">
		<div class="container">
			<div class="title-div">
				<h3 style="color: green;">${successfullyAddedAdmin}</h3>
				<h3 style="color: green;">${successfullyUpdated}</h3>
			...
			<div class="login-form">
				<form action="LoginAdminServlet" method="post">
					...
					<label class="anim"> <input type="checkbox"
						class="checkbox"> <span> Remember me ?</span>
					</label>
					<input type="submit" name="submit" value="login">
					<div class="register-forming">
						<p>
							To Register New Account -- <a href="register.jsp">Click Here</a>
						</p>
					</div>
				</form>
			</div>
