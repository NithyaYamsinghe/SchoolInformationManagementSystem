...
<head>
	...
	<link href="//fonts.googleapis.com/css?family=Alegreya+Sans"
		rel="stylesheet">
	<!-- styles-CSS-->
	<link rel="stylesheet" href="css/homeStudent.css" type="text/css">
	<!--footer-CSS-->
	<link href="css/footer.css" rel='stylesheet' type='text/css' />
	<!--header-CSS-->
	<link rel="stylesheet" href="css/header.css">
	<title>Southbank | Home Subject</title>
</head>
<body>
...
%>
	...
	<div class="main_content">
		<div class="container">
			<h1>Subject Information Management</h1>
			<a href="addSubject.jsp" class="button"> Add Subject </a><br> <br><br> <br>
			<form method="post" action="ListSubjectServlet">
				<button class="button">Update Subject</button>
			</form><br><br> <br>
			<a href="deleteSubject.jsp" class="button"> Delete Subject </a><br><br><br><br><br>
			<a href="viewSubject.jsp" class="button"> View Subject</a><br> <br><br> <br><br>
