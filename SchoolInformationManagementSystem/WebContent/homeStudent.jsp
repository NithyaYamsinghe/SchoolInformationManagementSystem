...
<head>
	...
	<title>Southbank | Home Student</title>
</head>
<body>
...
%>
	...
	<div class="main_content">
		<div class="container">
			...
			<a href="addStudent.jsp" class="button"> Add Student </a><br> <br><br> <br>
			<form method="post" action="ListStudentServlet">
				<button class="button">Update Student</button>
			</form><br><br> <br>
			<a href="deleteStudent.jsp" class="button"> Delete Student </a><br><br><br><br><br>
			<a href="viewStudent.jsp" class="button"> View Student</a><br> <br><br> <br><br>
			<a href="EmailForm.jsp" class="button"> Send Email </a><br><br><br><br>
			<form method="post" action="ListJoinServlet">
				<button class="button">Aptitude Test Registered Students Details</button>
			</form>
