...
<head>
    ...
    <!-- Title Page-->
    <title>Southbank | Search Student Marks</title>
    <!-- Footer-CSS -->
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Search Student Marks</h2>
                    <form method="POST" action="ViewStudentMarksServlet">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label for="stdID">Student ID</label>
                                    <input type="text" id="stdID" name="stdID" class="input--style-4"  required="required">
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit">Find Record(s)</button>
                        </div>
                    </form>
                </div>
            </div>
