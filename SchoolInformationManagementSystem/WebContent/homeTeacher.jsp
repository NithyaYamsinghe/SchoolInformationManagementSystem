...
<head>
	...
	<title>Southbank | Home Teacher</title>
</head>
<body>
...
%>
	...
	<div class="main_content">
		<div class="container">
			...
			<a href="addTeacher.jsp" class="button"> Add Teacher </a><br> <br><br> <br>
			<form method="post" action="ListTeacherServlet">
				<button class="button">Update Teacher</button>
			</form><br><br> <br>
			<a href="deleteTeacher.jsp" class="button"> Delete Teacher </a><br><br><br><br><br>
			<a href="viewTeacher.jsp" class="button"> View Teacher</a><br> <br><br> <br><br>
