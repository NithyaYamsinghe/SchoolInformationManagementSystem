...
<html lang="zxx">
<head>
	<title>Southbank | Contact Us</title>
	<!-- meta-tags -->
		...
		<div class="container">
			...
			<div class="bottom_header_right">
				<div class="bottom-social-icons">
					<a class="facebook" href="https://en-gb.facebook.com/login/">
						<span class="fa fa-facebook"></span>
					</a>
					<a class="twitter" href="https://twitter.com/login?lang=en">
						<span class="fa fa-twitter"></span>
					</a>
					<a class="pinterest" href="https://www.pinterest.com/login/">
						<span class="fa fa-pinterest-p"></span>
					</a>
					<a class="linkedin" href="https://www.linkedin.com/login">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="subjects.jsp" class="effect-3">Subjects</a>
								</li>
								<li>
									<a href="join.jsp" class="effect-3">Join Us</a>
								</li>
								
								<li>
									<a href="gallery.jsp" class="effect-3">Gallery</a>
								</li>
								<li class="active">
									<a href="contactUs.jsp" class="effect-3">Contact Us</a>
								</li>
							</ul>
						</nav>
					</div>
		...
		<div class="container">
			...
			<div class="contact-row">
				<div class="col-md-6 contact-text1">
					<h4>Contact Our
						<span>Southbank School</span>
					</h4>
					<p>Southbank is a well reputed international school all around the world, If you want to know more information about Southbank School contact us .
					</p>
				</div>
				<div class="col-md-6 contact-w3lsright">
					<iframe src="https://www.youtube.com/embed/dEa4FBILPNY">
	...
	<div class="contact-lsleft">
		<div class="container">
			<div class="address-grid">
				...
				<ul class="w3_address">
					<li>
						<span class="fa fa-globe" aria-hidden="true"></span>New Kampshire Mshinon,
							Foxhall Road, USA
					</li>
					<li>
