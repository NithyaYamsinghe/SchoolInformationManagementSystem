...
<head>
	...
	<title>Southbank | Home Marks</title>
</head>
<body>
...
%>
	...
	<div class="main_content">
		<div class="container">
			...
			<a href="addMarks.jsp" class="button">Add Marks</a><br> <br><br> <br><br>
			<a href="ListStudentsAll.jsp" class="button"> View All Marks </a><br> <br><br> <br></br>
			<a href="viewStudentMark.jsp" class="button"> View Marks By Student ID </a><br><br><br><br><br>
		</div>
	</div>
	<br>
	<br>
