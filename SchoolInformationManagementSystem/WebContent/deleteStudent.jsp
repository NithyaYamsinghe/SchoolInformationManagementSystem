...
<head>
    ...
    <!-- Title Page-->
    <title>Southbank | Delete Student</title>
    <!-- Footer-CSS -->
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="studentID" >
                                </div>
                            </div>
                         </div>
                        
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit">Delete Student</button>
                        </div>
                    </form>
                </div>
            </div>
